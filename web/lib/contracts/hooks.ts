...
import type { PoolInfo, VerificationParams, ProofType, ResalePolicy } from './types';
...
export function useSubmitProof(userContractAddress?: `0x${string}`) {
  ...
  const submitProof = async (
    ...
    return await writeContractAsync({
      ...
      args: [poolAddress, proofType, proofHash, encryptedCID, dataHash, zkParams, resalePolicy],
    });
  };
